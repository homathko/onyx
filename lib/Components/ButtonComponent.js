...
class ButtonComponent extends HardwareComponent {
    constructor(ident, pin, mediator) {
        ...
        this.addState('unpressed');
    
        // Set initial state
        this.setState('unpressed');
    ...
    //         this.sendActionNotification('push', { message: 'The button was pushed' });
    //     if (this.currentState === 'unpressed')
    //         this.sendActionNotification('release', { message: 'The button was released' })
    // }
