...
class EventDirector {
    ...
    buildCommandTable (devices) {
        this._commandMap.push(
            new CommandObject(devices['testButton'], [ devices['testLED'] ], {forInvokerState: 'pressed'}, devices['testLED'].turnOn),
            new CommandObject(devices['testButton'], [ devices['testLED'] ], {forInvokerState: 'released'}, devices['testLED'].turnOff),
            new CommandObject(devices['testButton'], [ devices['testLED'] ], {forInvokerState: 'held', forReceiverState: 'off'}, devices['testLED'].turnOff)
        );
